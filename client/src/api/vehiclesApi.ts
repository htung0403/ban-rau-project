...
export const vehiclesApi = {
  ...
  create: async (payload: { license_plate: string; vehicle_type?: string; load_capacity_ton?: number; goods_categories?: Array<'grocery' | 'vegetable'>; driver_id?: string; in_charge_id?: string }) => {
