...
const DateInput: React.FC<DateInputProps> = ({ value, onChange }) => {
  ...
  return (
    <div className="flex border border-border rounded-lg items-center text-[13px] font-bold px-2 py-1.5 bg-background">
      <input
        type="text"
        ref={dayRef}
        max={31}
      ...
      <input
        ...
        className="p-0 outline-none w-10 border-none text-center bg-transparent"
        placeholder="YYYY"
      />
    </div>
  )
